...
input_gc_bucket <- "gs://genetics-portal-ukbb-mr-eur/protein-gwas/PIETZNER/harmonised" # Path to input files in a google bucket

output_gc_bucket <- "gs://genetics-portal-ukbb-mr-eur/protein-gwas/PIETZNER/pan_filtered/" # Path to google bucket where exposure output files will be stored

outcome_gc_bucket <- "gs://genetics-portal-ukbb-mr-eur/protein-gwas/PIETZNER/pan_outcomes_gsmr_filtered/" # store the filtered exposure-SNP matched outcomes here
...
dataset_name <- "pietzner" # Name of dataset that will be created in BigQuery
